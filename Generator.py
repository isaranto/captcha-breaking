...
class LetterGenerator:
    def __init__(self, num_of_letters):
        self.image = ImageCaptcha(fonts=['data/fonts/DroidSansMono.ttf'])
    ...
    def make_images(self):
        ...
        for i in range(self.num_of_letters):
            for c in ascii_lowercase:
                ...
                self.image.write(c, "data/letters/"+c+"_"+str(i)+'.png')
            ground_truth[i] = c
...
class CaptchaGenerator:
    ...
    def make_images(self):
        ...
        for i in range(self.num_of_images):
            ...
            self.image.write(word, "data/images/"+str(i)+'.png')
            ground_truth[i] = word
...
if __name__=="__main__":
    #generator = CaptchaGenerator(6,100)
